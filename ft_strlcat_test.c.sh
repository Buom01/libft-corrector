...
#    Updated: 2019/11/07 21:01:39 by badam            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

#/bin/sh
./ft_strlcat_test.c.out "Ma chaine" " complete" "100" && OK || KO
./ft_strlcat_test.c.out "Ma chaine" " complete" "19" && OK || KO
./ft_strlcat_test.c.out "Ma chaine" " complete" "18" && OK || KO
./ft_strlcat_test.c.out "Ma chaine" " complete" "10" && OK || KO
./ft_strlcat_test.c.out "Ma chaine" " complete" "9" && OK || KO
./ft_strlcat_test.c.out "Ma chaine" " complete" "8" && OK || KO
